<template>
    <div class="bg declaration_wrap">
        <div class="header">
            <h1 class="warp_title"> declarationPage 页面</h1>
        </div>
        ...
        ></paginationCommon>
         <!-- 查看内容弹框 -->
         <describeDialog dialogTitle="declaration" :dialogVisible="dialogVisible" @handleClose="handleClose">
            <template v-slot:message>
                <span class="title">{{detailName}}</span>
                <p>
                    <span style="font-weight: bold">vue2.0的生命周期</span><br/>
                    beforeCreate、created/beforeMount、mounted<br/>
                    beforeUpdate、updated/beforDestroy、destroyed <br/><br/>
                    Life is not just about learning<br/>
                    要继续加油呀💪
